...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 10, 2023 at 09:53 AM
...
INSERT INTO `cadidate` (`S.no`, `Name`, `Voter_id`, `number`, `Email`, `password`, `photo`, `role`, `votes`) VALUES
(1, 'BOOKS', 'BOOK400', 332587413, 'book@gmail.com', '500', 'github-logo-1618427178074.jpg', 2, 0),
(2, 'Sunrise', 'SUN100', 789654123, 'sun@gmail.com', '300', 'Find the best global talent_.jpeg', 2, 0);
...
INSERT INTO `voters` (`S.no`, `Name`, `Voter_id`, `number`, `Email`, `password`, `photo`, `role`, `status`) VALUES
